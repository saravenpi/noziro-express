...
require("./door/index")(app, fetch, url, oauth, user, uuidv4)
require("./render/app")(app, user);
require("./render/chat/index")(app);
require("./render/chat/chat")(io, message, user);
require("./render/chat/deletemsg")(io, app, message);
...
require("./discordbot2")(Discord, Canvas, AntiSpam);
