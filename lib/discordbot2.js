...
var command = prefix + message.content
          ...
          if(command === "purge"){
             ...
             var messagecount = 100;
               ...
               if (!args[1]) return message.reply"clear <@ ou id de membre> <number>")
               if(args.isNaN) return message.reply"clear <@ ou id de membre> <number>")
               ...
               message.channel.fetchMessages({limit: 100}).then(function(messages) {
                 var messageArray = messages.array();
                   ...
                   message.reply("clear effectué pour les messages de " + memb.user.tag,messageArray.length + " messages")
